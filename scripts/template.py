...
for i in ind:
	...
	x1 = [u.replace('Rfile',posixpath.join('//data','dasgupab','lupusdeath',bname,'Rfile')) for u in x1]
...
f = open('Rfile.sw','w')
for i in ind:
	f.write('R --vanilla < '+posixpath.join('//data','dasgupab','lupusdeath',bname,'Rfile')+str(i)+'.R\n')
f.close()
